...
export default function Testimonals() {
  return (
    <div className=" w-full pl-20 pr-20 flex flex-col items-center gap-20 overflow-hidden ">
      <div className="max-w-[1200px] flex flex-col text-center gap-10">
        <h2>Testimonals</h2>
      ...
      <div className="flex gap-20 flex-1 flex-wrap">
        <div className="flex flex-1 justify-center cutout-back min-w-[550px]">
          <div className="flex flex-col cutout-2 max-w-[800px] p-20 bg-whiteColor text-blackColor gap-y-10 max-h-full">
            <Image
              className="cutout-4 object-cover h-[50%]"
              alt="guitar"
              width={1920}
              height={1080}
            ...
            <div className="flex-[2] flex flex-col gap-10">
              <h2 className=" font-bold">Dave's Ukelele</h2>
        ...
        <div className="flex flex-1 justify-center cutout-back min-w-[550px]">
          <div className="flex flex-col cutout-1 max-w-[800px] p-20 bg-whiteColor text-blackColor gap-y-10 max-h-full">
            <Image
              className="cutout-3 object-cover h-[50%]"
              alt="guitar"
              width={1920}
              height={1080}
            ...
            <div className="flex-[2] flex flex-col gap-10">
              <h2 className=" font-bold">Thank you for the Dola</h2>
              <h4 className=" text-blackColorSecondary">
                ...
                igniting a sense of joy and creativity that is truly enchanting.
              </h4>
            </div>
          </div>
        </div>
        <div className="flex flex-1 justify-center cutout-back min-w-[550px]">
          <div className="flex flex-col cutout-3 max-w-[800px] p-20 bg-whiteColor text-blackColor gap-y-10 max-h-full">
            <Image
              className="cutout-1 object-cover h-[50%]"
              alt="guitar"
              width={1920}
              height={1080}
            ...
            <div className="flex-[2] flex flex-col gap-10">
              <h2 className=" font-bold">Custom T-42</h2>
              <h4 className=" text-blackColorSecondary">
